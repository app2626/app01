...
function toFormState(product) {
  if (!product) {
    return {
      ...
      colorRows: [], variants: [], specList: [], promotions: [], giftIds: [], channels: []
    };
  }
  return {
    id: product.id || "",
    ...
    <div className="fixed inset-0 z-[90] flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <section className="space-y-2">
            <h3 className="text-sm font-bold text-gray-700">ช่องทางการรับจอง</h3>
            <p className="text-[11px] text-gray-500">เลือกได้หลายช่องทาง — ไม่เลือกเลย = อนุญาตให้จองได้ทุกช่องทาง</p>
